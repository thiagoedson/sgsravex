...
while ($i <= ($result - 1)) {
	...
	?>
	<label style="border: solid; display: block; text-align: center; border-width: thin; background-color: <?php echo $classe; ?>;"><?php echo $mes; ?>
		<div style="padding: 10px;">
			<span class="glyphicon glyphicon-user" aria-hidden="true"></span> <?php echo $aniversrio[$i]['nome'] . " - " . $aniversrio[$i]['data'] . " - $testeadata"; ?>
